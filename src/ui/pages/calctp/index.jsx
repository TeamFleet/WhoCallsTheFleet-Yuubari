...
class PageCalcTP extends Component {
    constructor(props) {
        super(props);
        props.dispatch(
            pageInit(pageId, {
    ...
    render() {
        return (
            <Page className={this.props.className}>
                ...
                />
                <PageCalcTPBody className={this.props.className + '-body'} />
            </Page>
        );
    }
}
...
const PageCalcTPHeader = ({ className }) => (
    <Header
        ...
        options={<PageCalcTPResult className={className + '-result'} />}
    />
);
...
class PageCalcTPBody extends Component {
    count = {
        shipType: {},
        equipmentType: {},
    };
...
const PageCalcTPCounter = ({ className, name, min = 0, onUpdate, icon }) => {
    return (
        <div className={className}>
