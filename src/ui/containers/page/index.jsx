...
class ContainerPage extends Component {
    ...
    shouldComponentUpdate(newProps) {
        ...
        if (
            ...
            this.props.locationBeforeTransitions.pathname !==
                newProps.locationBeforeTransitions.pathname
        ) {
            if (__DEV__) {
                const style = (str) =>
                    [
            ...
            lastScrollY[this.props.locationBeforeTransitions.pathname] =
                window.scrollY;
            return false;
        }
        ...
        if (
            // !this.updating &&
            newProps.rendering !== this.props.rendering &&
            !newProps.rendering
        ) {
            this.restoreScrollY();
            return false;
    ...
    componentDidMount() {
        ...
        } else delete lastScrollY[this.props.pathname];
    }
    ...
    render() {
        ...
        ['locationBeforeTransitions', 'rendering', 'dispatch'].forEach(
